...
public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler
{
	...
	private void LateUpdate()
	{
		...
		int num = TMP_TextUtilities.FindIntersectingCharacter((TMP_Text)m_TextMeshPro, Input.mousePosition, Camera.main, true);
		...
		int num2 = TMP_TextUtilities.FindIntersectingLink((TMP_Text)m_TextMeshPro, Input.mousePosition, m_Camera);
		...
		int num3 = TMP_TextUtilities.FindIntersectingWord((TMP_Text)m_TextMeshPro, Input.mousePosition, Camera.main);
